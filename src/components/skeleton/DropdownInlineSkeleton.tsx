...
export const DropDownInlineSkeleton = () => {
  return (
    <div className="border-gray-20 bg-gray-0 absolute top-[15px] right-[-6px] z-[1000] mt-2 inline-flex w-[214px] flex-col rounded-[10px] border p-[4px] text-[14px] font-[500] shadow">
