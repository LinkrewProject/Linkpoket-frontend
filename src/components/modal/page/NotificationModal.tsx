...
export default function NotificationModal({
  ...
  return (
    <div className="absolute top-14 right-16 z-20" ref={modalRef}>
      ...
      >
        {/* 탭: 전체 / 페이지 초대 / 받은 폴더 */}
        <div className="border-gray-30 mb-1 flex gap-1 border-b" role="tablist">
          <button
            role="tab"
          ...
          <button
            role="tab"
            aria-selected={selectedTab === 'invite'}
            aria-controls="notification-panel"
          ...
          <button
            role="tab"
            aria-selected={selectedTab === 'directory'}
            aria-controls="notification-panel"
                  ...
                  <div className="flex items-start gap-[10px]">
                    ...
                    <div className="text-gray-90 flex-1 text-sm font-[400]">
                      ...
                      <div className="text-gray-60 text-xs">
                        {new Date(item.senderInfo.sentAt).toLocaleString(
                          'ko-KR'
                        )}
                      </div>
                    </div>
